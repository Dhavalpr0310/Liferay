...
private static final Set<String> _TYPES = new HashSet<>(Arrays.asList("color", "email", "number", "range", "tel", "text", "textarea"));
  ...
  static {
    ...
    _jspx_dependants.put("/html/taglib/aui/input/init.jsp", Long.valueOf(1732751611378L));
    ...
    _jspx_dependants.put("/html/taglib/aui/input/init-ext.jspf", Long.valueOf(1732751184795L));
  }
